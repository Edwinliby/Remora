            ...
            <div className="relative mt-16">
                ...
                <div className="relative z-10 px-8 py-16 text-center">
                    ...
                    <div className="relative mt-8 md:mt-14 max-w-[1200px] h-full mx-auto">
                        ...
                        <span className="absolute top-[6px] left-1/2 z-30 flex md:h-8 md:w-8 h-6 w-6 -translate-x-1/2 -translate-y-1/2 transform items-center justify-center rounded-full bg-[#D1D6FF] border-4 md:border-6 md:text-lg border-[#E6E8FF] text-primary font-bold"/>
